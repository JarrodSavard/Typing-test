// constants
const wordListContainer = <HTMLElement>document.querySelector(".word-list-container");
const wordList = <HTMLElement>document.querySelector(".word-list");
const userInput = <HTMLInputElement>document.querySelector(".word-input");
const resetButton = <HTMLButtonElement>document.querySelector(".reset-button");
const correctCount = <HTMLElement>document.querySelector(".correct-words-count");
const incorrectCount = <HTMLElement>document.querySelector(".incorrect-words-count");
const timeLeft = <HTMLElement>document.querySelector(".time-left");
const wpmCount = <HTMLElement>document.querySelector(".wpm-count");
